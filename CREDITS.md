...
When redistributing substantial portions of the project, preserve the copyright and license notice required by the MIT License and retain reasonable attribution to the original project and author.
...
External contributors should receive credit for accepted work through Git history, pull requests, release notes, and this file when appropriate. Contributor credit does not transfer ownership of the project or imply endorsement.
